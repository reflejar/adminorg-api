...
from admincu.operative.serializers.operaciones.interno import (
	LineaModelSerializer,
)

from admincu.operative.CU.operaciones.internos import CU

class InternoModelSerializer(DocumentoModelSerializer):
	'''
