  ...
  return (
    <Formik
      ...
      validationSchema={Yup.object().shape({
        ...
        propietario: Yup.number().required(empty),
        inquilino: Yup.number().required(empty),
        domicilio_superficie_total: Yup.number().required(empty),
        domicilio_superficie_cubierta: Yup.number().required(empty),
        ...
        domicilio_piso: Yup.string(),
        domicilio_manzana: Yup.string(),
        domicilio_oficina: Yup.string(),
        domicilio_sector: Yup.string(),
        domicilio_torre: Yup.string(),
        domicilio_parcela: Yup.string(),
        domicilio_catastro: Yup.string(),
      })}
